        ...
        afterLoad:function(link,index){
            ...
            case 5:
                $('#sec6li').bind('mouseover',function(){
                    $('#sec6pic').attr('src','images/weixin.jpg'/*tpa=http://huan521.com/javascripts/image/weixin.png*/);

                });
                $('#sec6li').bind('mouseout',function(){
                    $('#sec6pic').attr('src','images/qq.jpg'/*tpa=http://huan521.com/javascripts/image/qq.jpg*/)
